  ...
  return (
    <>
      <div className="flex justify-center items-center gap-5">
        <a href={linkTwitter}>
          <img src={TwitterLogo} alt="Lien vers notre compte X" className="w-16" />
        </a>
        <a href={linkDiscord}>
          <img src={DiscordLogo} alt="Lien vers notre Discord" className="w-16" />
        </a>
        <a href={linkTensor}>
          <img src={TensorLogo} alt="Lien vers les Sketchies sur Tensor" className="w-16" />
        </a>
        <a href={linkME}>
          <img src={MELogo} alt="Lien vers les Sketchies sur Magic Eden" className="w-16" />
        </a>
        <a href={linkExchange}>
          <img src={ExchangeLogo} alt="Lien vers notre Exchange.art" className="w-16" />
        </a>
      </div>
    </>
  )
